...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Executes consectuative binary operations between the argument of inject() and each of the elements in the array on which inject is called.
  end
  ...
  #
  # So to not seperate the code and the memory that holds the file?
