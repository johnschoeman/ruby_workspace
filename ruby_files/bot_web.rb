...
class BotServlet < WEBrick::HTTPServlet::AbstractServlet
  ...
  #A basic HTML template consisting of a basic page with afor and test entry bos for the user to cnvers with our bot.  It uses some placeholder text (%RESPONSE%) so the bot's responses can be substituted in easily later.
  @@html = %q{
    <html><body>
      <form method="get">
        <h1>Talk To A Bot</h1>
...
#Create an HTTP server on port 1234 of the local machine accessile via http://localhost:1234/ or http://127.0.0.1:1234/
